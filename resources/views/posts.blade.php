<x-layout>
      ...
      <form>
        ...
        <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
          <div class="relative w-full">
            ...
            <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search for articles" type="text" id="search" name="search" autocomplete="off">
          </div>
          <div>
  ...
  {{ $posts->links() }}
  <section class="dark:bg-gray-900 py-4">
    <div class="grid gap-8 lg:grid-cols-3">
      @forelse ($posts as $post)
      <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div class="flex justify-between items-center mb-5 text-gray-500">
          <a href="/posts?category={{ $post->category->slug }}" class="text-base text-gray-500">
      ...
      <div>
        ...
        <a href="/posts" class="block font-semibold text-blue-600 my-4 hover:underline">&laquo; Back to all posts</a>
      </div>
      @endforelse
    </div>
  </section>
